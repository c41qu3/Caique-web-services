...
namespace WebApplication2.Models
{
    ...
    //-------------------------------- AQUI COMEÇA A CLASSE DO NCARRO
    public class clienteviewmodelnCarro {
        ...
        public clienteviewmodelnCarro()
            {


            }
       }
    public class ClienteViewModelTelanCarro
    {
        ...
        public ClienteViewModelTelanCarro()
        {

        }

        public ClienteViewModelTelanCarro(byte[] foto1BA, byte[] foto2BA,String desc) //esse modelo eu uso pra exibir
        {
            descricao = desc;
           
            string IB1 = Convert.ToBase64String(foto1BA);
            foto1 = string.Format("data:image/gif;base64,{0}", IB1);
            string IB2 = Convert.ToBase64String(foto2BA);
            foto2= string.Format("data:image/gif;base64,{0}", IB2);
